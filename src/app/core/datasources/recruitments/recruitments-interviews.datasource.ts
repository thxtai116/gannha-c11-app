...
@Injectable()
export class RecruitmentInterviewsDataSource extends BaseDataSource {
    ...
    load(queryParams: QueryParamsModel) {
        ...
        from(this._recService.getInterviews(queryParams.filter.unitId, queryParams.filter.isActive, queryParams.pageNumber, queryParams.pageSize)).pipe(
            tap(res => {
