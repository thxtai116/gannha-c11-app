...
export class RecommendationsDataSource extends BaseDataSource {
    ...
    init(data: Observable<RecommendationOverviewViewModel[]>, queryParams: QueryParamsModel) {
    ...
    load(data: RecommendationOverviewViewModel[], queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
