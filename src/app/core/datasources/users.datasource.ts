...
import { UserInfoOverviewViewModel } from "../view-models/index";
...
export class UsersDataSource extends BaseDataSource {
    ...
    init(data: Observable<UserInfoOverviewViewModel[]>, queryParams: QueryParamsModel) {
    ...
    load(data: UserInfoOverviewViewModel[], queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
