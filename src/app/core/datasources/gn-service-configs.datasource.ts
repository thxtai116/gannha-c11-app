...
export class GnServiceConfigsDataSource extends BaseDataSource {
    ...
    init(data: Observable<GnServiceConfigOverviewViewModel[]>, queryParams: QueryParamsModel) {
    ...
    load(data: GnServiceConfigOverviewViewModel[], queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
