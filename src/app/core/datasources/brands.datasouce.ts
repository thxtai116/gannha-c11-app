...
import { BrandViewModel } from "../view-models/index";
...
export class BrandsDataSource extends BaseDataSource {
    ...
    init(data: Observable<BrandViewModel[]>, queryParams: QueryParamsModel) {
    ...
    load(data: BrandViewModel[], queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
