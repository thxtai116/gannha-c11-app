...
import { CategoryViewModel } from "../view-models/index";
...
export class CategoriesDataSource extends BaseDataSource {
    ...
    init(data: Observable<CategoryViewModel[]>, queryParams: QueryParamsModel) {
    ...
    load(data: CategoryViewModel[], queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
