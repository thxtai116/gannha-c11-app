...
import { JobViewModel } from "../view-models/index";
...
export class JobsDataSource extends BaseDataSource {
    ...
    init(data: Observable<JobViewModel[]>, queryParams: QueryParamsModel) {
    ...
    load(data: JobViewModel[], queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
