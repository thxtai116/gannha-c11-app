...
export class SellingPointTypesDataSource extends BaseDataSource {
    ...
    init(data: Observable<SellingPointTypeViewModel[]>, queryParams: QueryParamsModel) {
    ...
    load(data: SellingPointTypeViewModel[], queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
