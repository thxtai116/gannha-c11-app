...
export class LayoutConfig implements ConfigModel {
	public config: any = {
		...
		self: {
			...
			background: './assets/app/media/img/bg/bg-3.jpg' // boxed layout background
		},
		...
		header: {
			...
			self: {
				...
				logo: {
					dark: './assets/demo/default/media/img/logo/gannha-logo_32.png',
					light: './assets/demo/default/media/img/logo/gannha-logo_32.png'
				}
			},
			...
			aside: {
				...
				desktop_and_mobile: {
					...
					submenu: {
						...
						accordion: true, // Set accordion submenu toggle mode(set to false to enable submenu dropdown mode)
