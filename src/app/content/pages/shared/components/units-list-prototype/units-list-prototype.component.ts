...
@Component({
    selector: 'm-units-list-prototype',
    templateUrl: './units-list-prototype.component.html',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => UnitsListPrototypeComponent),
            multi: true,
        }
    ],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UnitsListPrototypeComponent implements OnInit, AfterViewInit, ControlValueAccessor {
